...
public class MySorts {
    public static void silentSort( ArrayList<Comparable> data )
    {//does not print anything, uses insertionSort method
    ...
    public static ArrayList<Comparable> populate( int size, int lo, int hi ) {
